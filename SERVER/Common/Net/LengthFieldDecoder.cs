...
public class LengthFieldDecoder
{
    ...
    public event ReceivedHandler MOnDataRecived;
    public event DisconnectedHandler MOnDisconnected;
    ...
    public void Init()
    {
        ...
        {
            m_isStart = true;
            m_Socket.BeginReceive(m_buffer, m_offect, m_size - m_offect, SocketFlags.None, new AsyncCallback(OnReceive),
                null);
        }
    }
    ...
    public void OnReceive(IAsyncResult result)
    {
        try
        {
            ...
            if (m_Socket != null && m_Socket.Connected)
            {
                m_Socket.BeginReceive(m_buffer, m_offect, m_size - m_offect, SocketFlags.None,
